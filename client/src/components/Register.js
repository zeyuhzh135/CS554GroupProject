...
const Register = () => {
    ...
    const handleRegister = async () => {
        ...
        if (inputErrors.length > 0) {
            ...
            try {
                let apiResponse = await axios.post('/users', {
                    firstName: firstName.value,
                    lastName: lastName.value,
                    email: email.value,
                    password: password.value,
                    password_confirm: confirmedPasseord.value,
                    isteacher: isteacher,
                    city: city.value,
                    state: state.value
                });
                ...
                <div className='register-card' key='register'>
                    <div className='card-body'>
                        ...
                        <div className="register-form-div">
                            <label>First Name
                                <br/>
                                <input type='text' {...firstName} name='first_name' placeholder='First Name'/>
                            </label>
                            <br/>
                            <label>Last Name
                                <br/>
                                <input type='text' {...lastName} name='last_name' placeholder='Last Name'/>
                            </label>
                            <br/>
                            <label>Email
                                <br/>
                            ...
                            <label>Confirmed Password
                                <br/>
                                <input type='password' {...confirmedPasseord} name='confirmed_password'
                            ...
                            <label>City
                                <br/>
                                <input type='text' {...city} name='city' placeholder='City'/>
                            </label>
                            <br/>
                            <label>State
                                <br/>
            ...
            <div>
                <div className='register-card' key='register'>
                    <div className='card-body'>
                        ...
                        <div>
                            <label>First Name<br/>
                            <input type='text' {...firstName} name='first_name' placeholder='First Name'/></label><br/>
                            <label>Last Name<br/>
                            <input type='text' {...lastName} name='last_name' placeholder='Last Name'/></label><br/>
                            <label>Email<br/>
                            <input type='text' {...email} name='email' placeholder='Email'/></label><br/>
                            <label>Password<br/>
                            <input type='password' {...password} name='password' placeholder='Password'/></label><br/>
                            <label>Confirmed Password<br/>
                            <input type='password' {...confirmedPasseord} name='confirmed_password'
                                   placeholder='Confirmed Password'/></label><br/>
                            <lable>I am a
                            <select name='role' {...role} id='role'>
                            ...
                            <label>City<br/>
                            <input type='text' {...city} name='city' placeholder='City'/></label><br/>
                            <label>State<br/>
                            <select name='state' {...state} id='state'>
                                <option value="" defaultValue="selected">Select a State</option>
                                <option value="AL">Alabama</option>
